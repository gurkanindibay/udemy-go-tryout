...
const (
	...
	EventService_RegisterForEvent_FullMethodName     = "/event.EventService/RegisterForEvent"
	EventService_CancelRegistration_FullMethodName   = "/event.EventService/CancelRegistration"
	EventService_GetUserRegistrations_FullMethodName = "/event.EventService/GetUserRegistrations"
)
...
func (c *eventServiceClient) RegisterForEvent(ctx context.Context, in *RegisterForEventRequest, opts ...grpc.CallOption) (*RegisterForEventResponse, error) {
	...
	err := c.cc.Invoke(ctx, EventService_RegisterForEvent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) CancelRegistration(ctx context.Context, in *CancelRegistrationRequest, opts ...grpc.CallOption) (*CancelRegistrationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelRegistrationResponse)
	err := c.cc.Invoke(ctx, EventService_CancelRegistration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *eventServiceClient) GetUserRegistrations(ctx context.Context, in *GetUserRegistrationsRequest, opts ...grpc.CallOption) (*GetUserRegistrationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserRegistrationsResponse)
	err := c.cc.Invoke(ctx, EventService_GetUserRegistrations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedEventServiceServer) CancelRegistration(context.Context, *CancelRegistrationRequest) (*CancelRegistrationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelRegistration not implemented")
}
func (UnimplementedEventServiceServer) GetUserRegistrations(context.Context, *GetUserRegistrationsRequest) (*GetUserRegistrationsResponse, error) {
...
func _EventService_CancelRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelRegistrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).CancelRegistration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_CancelRegistration_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).CancelRegistration(ctx, req.(*CancelRegistrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _EventService_GetUserRegistrations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserRegistrationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EventServiceServer).GetUserRegistrations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EventService_GetUserRegistrations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EventServiceServer).GetUserRegistrations(ctx, req.(*GetUserRegistrationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EventService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _EventService_CancelRegistration_Handler,
		},
		{
			MethodName: "GetUserRegistrations",
			Handler:    _EventService_GetUserRegistrations_Handler,
		},
	},
